...
if __name__ == "__main__":
    ...
    parser.add_argument('--tabu_tenure', type=int, default=50, help='tabu tenure size')
    parser.add_argument('--max_steps', type=int, default=500, help='max number of steps')
    parser.add_argument('--neighborhood_size', type=int, default=10, help='neighborhood size')
    ...
    parser.add_argument('--dynamic_tenure', action='store_true', help='tabu tenure will increase by 10 each max_steps')
    parser.add_argument('--dynamic_loop', type=int, default=10, help='set loop when using dynamic strategy')
    ...
    if opt.dynamic_tenure:
        ...
        for _ in range(opt.dynamic_loop):
            ...
            algorithm = Algorithm(result, tabu_tenure, 
                                  max_steps, opt.neighborhood_size, 
                                  constraints=opt.constraints, print_interval=opt.interval, max_score=None)
            result, score = algorithm.run(verbose=opt.verbose)
